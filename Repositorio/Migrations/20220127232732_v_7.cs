...
namespace Repositorio.Migrations
{
    public partial class v_7 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("INSERT INTO Associado (nome, nomeUsuario, senha, dataNascimento, status, planoId, quantidadeExamesAno, possuiOdontologico, valorPlanoAdicional) VALUES ('Rogério Santos','rogerio', '123456','1990-06-10',1,3,30,1,0)");
            migrationBuilder.Sql("INSERT INTO Associado (nome, nomeUsuario, senha, dataNascimento, status, planoId, quantidadeExamesAno, possuiOdontologico, valorPlanoAdicional) VALUES ('Clara Camilo','clarinha', '123456','1990-03-10',2,1,10,0,0)");
            ...
            migrationBuilder.Sql("INSERT INTO Associado (nome, nomeUsuario, senha, dataNascimento, status, planoId, quantidadeExamesAno, possuiOdontologico, valorPlanoAdicional) VALUES ('Alisson Mendonça','aliali', '123456','1990-04-10',2,1,10,0,0)");
            migrationBuilder.Sql("INSERT INTO Associado (nome, nomeUsuario, senha, dataNascimento, status, planoId, quantidadeExamesAno, possuiOdontologico, valorPlanoAdicional) VALUES ('Fernando Ribeiro','fefe', '123456','1990-04-10',1,1,10,0,0)");
            migrationBuilder.Sql("INSERT INTO Associado (nome, nomeUsuario, senha, dataNascimento, status, planoId, quantidadeExamesAno, possuiOdontologico, valorPlanoAdicional) VALUES ('Shawn Mendes','shashaw', '123456','1990-04-10',2,4,15,0,0)");
            migrationBuilder.Sql("INSERT INTO Associado (nome, nomeUsuario, senha, dataNascimento, status, planoId, quantidadeExamesAno, possuiOdontologico, valorPlanoAdicional) VALUES ('Loris Ribeiro','lori', '123456','1990-04-10',1,5,25,0,0)");
